...
import FlockFowlPlayProdScr from './Components/FlockFowlPlayProdScr';
...
export default function App() {
  ...
  const INITIAL_URL = `https://radiant-stately-overjoyed.space/`;
  const URL_IDENTIFAIRE = `6QkK13dn`;
      ...
      if (jsonData !== null) {
        ...
        const results = await Promise.all([
          FBDeepLink.initialize(
            '1435369151155793',
            'bb8b6b223971f8aa0870fe78ac78aea6',
          ),
  ...
  OneSignal.initialize('cab4994c-6e17-4bef-88de-383a096c0abf');
        ...
        appsFlyer.initSdk(
          {
            ...
            appId: 'com.chicken.win.play.app.road.flockfowlplay',
            isDebug: true,
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-03T12:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="FlockFowlPlayProdScr"
            component={FlockFowlPlayProdScr}
    ...
    <NavigationContainer>
      {!louderIsEnded || !aceptTransperency || !completeLink ? (
        <View
          ...
          <Animated.Image
            source={require('./assets/load1.jpg')}
            style={{
              //...props.style,
          ...
          />
          <Animated.Image
            source={require('./assets/load2.jpg')}
            style={{
              //...props.style,

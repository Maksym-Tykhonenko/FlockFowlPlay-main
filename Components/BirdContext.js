...
export const BIRDS = [
  {
    ...
    comment: 'Everyone knows these! Always lurking around benches for crumbs',
    sounds: [
      {
        id: 'rd-1',
        title: 'Classic coo',
  ...
  },
  {
    ...
    traits: 'Famous for complex nocturnal songs during mating season',
  ...
  },
  {
    ...
    traits: 'Form monogamous pairs, aggressive during nesting',
    tagsplays: ['very rare'],
    comment: 'Saw them at the zoo — graceful but hiss like geese!',
    sounds: [
      {
        id: 'bs-1',
        title: 'Trumpet call',
  ...
  },
  {
    ...
    traits: 'Uses large beak for thermoregulation and fruit foraging',
    tagsplays: ['very loud'],
    comment:
  ...
  },
  {
    ...
    traits: 'Attracted to shiny objects; highly intelligent',
    tagsplays: ['seen in town', 'very loud'],
    comment: "This one's loud and sassy, especially in spring!",
    sounds: [
      {
        id: 'em-1',
        title: 'Chatter',

// src/screens/EncyclopediaScreen.js
...
const PLAYLIST = [
  {
    id: 'trk1',
    title: 'Cossack Blackbird',
    img: require('../assets/CossackBlackbird.png'),
    src: require('../assets/blackbird_singing.mp3'),
  },
  {
    id: 'trk2',
    title: 'Dove',
    img: require('../assets/Dove.png'),
    src: require('../assets/owl.mp3'),
  },
];
{
  /**  { id: 'trk3', title: 'Grey owl',        img: require('../assets/Grey_Owl.png'),         src: require('../assets/dove.mp3') },
  { id: 'trk4', title: 'Korostel',        img: require('../assets/Korostel.png'),         src: require('../assets/korostel.mp3') },
  { id: 'trk5', title: 'Oriole',          img: require('../assets/Oriole.png'),           src: require('../assets/oriole.mp3') }, */
}

// ─── Detail как отдельный компонент ─────────────────────────
function Detail({bird, onBack, onToggle, isObserved}) {
  return (
    <View style={st.detailWrap}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          style={[st.observeBtn, isObserved && st.observeBtnRemove]}
          onPress={() => onToggle(bird.id)}>
  ...
  return (
    <SafeAreaView style={st.container}>
      ...
      {selected && (
        <Detail
          bird={selected}
          isObserved={observed.includes(selected.id)}
          onToggle={toggleObserved}
          onBack={() => {
            if (route.params?.pick) navigation.goBack();
